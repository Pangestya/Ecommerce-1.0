<x-pengawas-layout>
    ...
    <div class="max-w-8xl mx-auto sm:px-3">
        <div class="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>/</span>
                <span class="text-[#80489C] font-medium">Edit {{ $user->name }}</span>
        </div>
    </div>
    ...
    <div class="py-6">
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <div class="bg-white rounded-xl shadow-md p-5 border-l-4 border-[#80489C]">
                    <div class="flex items-center">
                        <div class="w-12 h-12 rounded-full bg-gradient-to-r from-[#80489C] to-[#9a65b3] flex items-center justify-center mr-4">
                ...
                <div class="bg-white rounded-xl shadow-md p-5">
                    <div class="flex items-center">
                        <div class="w-12 h-12 rounded-full flex items-center justify-center mr-4 
                            {{ $user->role == 1 ? 'bg-red-100' : ($user->role == 2 ? 'bg-blue-100' : 'bg-green-100') }}">
                            <i class="fas {{ $user->role == 1 ? 'fa-user-shield text-red-600' : ($user->role == 2 ? 'fa-eye text-blue-600' : 'fa-shopping-cart text-green-600') }} text-xl"></i>
                        </div>
                        <div>
                            <p class="text-sm text-gray-600">Role Saat Ini</p>
                            <p class="text-lg font-bold text-gray-900">
                                {{ $user->role == 1 ? 'Administrator' : ($user->role == 2 ? 'Pengawas' : 'Pembeli') }}
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                ...
                <div class="bg-gradient-to-r from-gray-50 to-gray-100 px-6 py-4 border-b border-gray-200">
                    <div class="flex items-center">
                        ...
                        <div>
                            <h3 class="text-lg font-bold text-gray-900">Form Edit Pengguna</h3>
                ...
                <div class="p-6">
                    ...
                    <form action="{{ route('pengawas.users.update', $user->id) }}" method="POST" id="editUserForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-8">
                            ...
                            <select name="role" class="hidden" id="roleSelect">
                                <option value="2" {{ old('role', $user->role) == 2 ? 'selected' : '' }}>Pengawas</option>
                        ...
                        <div class="mb-8">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <span class="text-xs text-gray-500 italic">(Kosongkan jika tidak ingin mengubah)</span>
                            </div>
            ...
            <!-- Danger Zone -->
            <div class="mt-8 bg-gradient-to-r from-red-50 to-rose-50 border border-red-200 rounded-xl overflow-hidden">
                ...
                <div class="p-6">
                    <div class="flex flex-col md:flex-row md:items-center justify-between">
                        <div>
                            <h5 class="font-medium text-red-900">Hapus Akun Pengguna</h5>
                            <p class="text-sm text-red-700 mt-1">
                                Tindakan ini akan menghapus akun {{ $user->name }} secara permanen.
                                Data yang dihapus tidak dapat dikembalikan.
                            </p>
                        </div>
                        <button type="button" 
                                onclick="showDeleteConfirmation()"
                                class="mt-4 md:mt-0 px-5 py-2.5 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors duration-200 font-medium">
    ...
    <div id="deleteModal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex items-center justify-center p-4">
        <div class="bg-white rounded-xl shadow-2xl max-w-md w-full">
            <div class="p-6">
                ...
                <h3 class="text-xl font-bold text-gray-900 text-center mb-2">Konfirmasi Penghapusan</h3>
                ...
                <div class="flex space-x-4">
                    ...
                    <form action="{{ route('pengawas.users.destroy', $user->id) }}" method="POST" class="flex-1">
                        @csrf
                        @method('DELETE')
                        <button type="submit" 
                                class="w-full px-4 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors duration-200 font-medium">
                            Ya, Hapus
                        </button>
                    </form>
                </div>
